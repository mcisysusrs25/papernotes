    ...
    function init() {
        ...
        try {
            ...
            if (currentDiaryId && diaries[currentDiaryId]) {
                ...
                window.location.href = '/papernotes/dashboard.html';
            }
            ...
            if (notesContainer) {
                notesContainer.innerHTML = `
                    <div style="padding: 20px; background-color: #fff; border-radius: 8px; margin: 20px auto; max-width: 600px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                        ...
                        <a href="/papernotes/dashboard.html" style="display: inline-block; margin-top: 20px; padding: 8px 16px; background-color: #2a3f54; color: white; text-decoration: none; border-radius: 4px;">
